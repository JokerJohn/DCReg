...
- 停车场 source frame 已随仓库放在 [`DCReg/data/Parking-Lot-example/`](https://github.com/JokerJohn/DCReg/tree/main/DCReg/data/Parking-Lot-example)，大尺寸 prior map 请通过 README 中的数据链接下载后再运行真实场景 demo。
